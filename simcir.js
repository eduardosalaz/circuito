  ...
  var createDeviceController = function(device) {
    ...
    var createUI = function() {
      ...
      var label_dblClickHandler = function(event) {
        ...
        var title = 'Ingresar nombre del circuito ';
  ...
  var createDeviceRefFactory = function(data) {
    return function(device) {
      ...
      $.each($devs, function(i, $dev) {
        ...
        if (deviceDef.type == 'Entrada' || deviceDef.type == 'Salida') {
          $ports.push($dev);
        }
      });
...
!function($s) {
  ...
  $s.registerDevice('Entrada', createPortFactory('in') );
  $s.registerDevice('Salida', createPortFactory('out') );
  $s.registerDevice('Union', createJointFactory() );
