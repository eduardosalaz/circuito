...
!function($s) {
  ...
  */
  ...
  $s.registerDevice('Activar', createSwitchFactory('Toggle') );
  ...
  $s.registerDevice('16segundos', createLEDSegFactory(_16Seg) );
  $s.registerDevice('4bit7seg', createLED4bitFactory() );

  // register Rotary Encoder
  $s.registerDevice('CodificadorRotario', createRotaryEncoderFactory() );

  $s.registerDevice('BusEntradas', function(device) {
  ...
  $s.registerDevice('BusSalidas', function(device) {
